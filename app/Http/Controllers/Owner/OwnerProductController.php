...
class OwnerProductController extends Controller
{
  ...
  public function index(Request $request): JsonResponse
  {
    try {
      ...
      $query = Products::where('owner_id', $ownerId);
      ...
      $stats = [
        'total_products' => Products::where('owner_id', $ownerId)->count(),
        'active_products' => Products::where('owner_id', $ownerId)->where('product_status', true)->count(),
        'out_of_stock' => Products::where('owner_id', $ownerId)->where('current_stock', 0)->count(),
        'low_stock' => Products::where('owner_id', $ownerId)
          ->where('current_stock', '>', 0)
          ->where('current_stock', '<=', 10)
          ->count(),
        'total_inventory_value' => Products::where('owner_id', $ownerId)
